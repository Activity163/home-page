...
import { X, Moon, Sun, Monitor, Globe, Layout, Image, Zap, Download, Upload, User, Type, Clock as ClockIcon } from 'lucide-react';
        ...
        <div className="p-6 space-y-8 max-h-[80vh] overflow-y-auto custom-scrollbar">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {/* Show Lunar Calendar Toggle */}
              <label className="flex items-center justify-between cursor-pointer group">
                <div className="flex items-center gap-3 text-gray-700 dark:text-zinc-200">
                  <Type size={18} className="text-gray-400 dark:text-zinc-500" />
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => updateSettings('showLunar', e.target.checked)}
                  />
              ...
              <label className="flex items-center justify-between cursor-pointer group">
                <div className="flex items-center gap-3 text-gray-700 dark:text-zinc-200">
                  <ClockIcon size={18} className="text-gray-400 dark:text-zinc-500" />
